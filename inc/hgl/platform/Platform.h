...
// Safe merge helper for four ASCII chars into a 32-bit literal
...
// CPU identifiers
//--------------------------------------------------------------------------------------------------
#define HGL_CPU_X86_32              HGL_MERGE32('x','8','6',' ')
...
#define HGL_COMPILER_DigitalMars    HGL_MERGE32('D','M','C',' ')
...
//--------------------------------------------------------------------------------------------------
    ...
    #define HGL_ENDIAN                  HGL_BIG_ENDIAN
      ...
      defined(__POWERPC__)|| defined(__ppc__)      || defined(__PPC__) || defined(__ppc) || \
      defined(_M_PPC)    || defined(_M_MPPC)      || \
      defined(_ARCH_PPC) || defined(_ARCH_PWR)
    #if defined(__ppc64__) || defined(__PPC64__) || defined(__powerpc64__) || defined(_ARCH_PPC64) || defined(__64BIT__)
    ...
    #define HGL_MIN_MEMORY_ALLOC_BYTES  4
    #define HGL_ENDIAN                  HGL_LITTLE_ENDIAN
#elif defined(__ARM_ARCH) || defined(__arm__) || defined(_M_ARM)
...
//--------------------------------------------------------------------------------------------------
    ...
    #define HGL_OS_BSD      1
#elif defined(__OpenBSD) || defined(__OPENBSD__) || defined(__OpenBSD__)
...
// Guard against conflicting macro definitions prior to including our own helpers
#if defined(SetEventCall) || defined(SafeCallEvent) || defined(CallEvent) || defined(DefEvent)
    #error SetEventCall, SafeCallEvent, CallEvent or DefEvent already defined.
#endif

#if defined(Property) || defined(PropertyRead) || defined(PropertyWrite)
    #error Property, PropertyRead or PropertyWrite already defined.
#endif

//--------------------------------------------------------------------------------------------------
// Bring in OS/Compiler specific helpers
//--------------------------------------------------------------------------------------------------
    ...
    #elif (HGL_COMPILER == HGL_COMPILER_MinGW64) || (HGL_COMPILER == HGL_COMPILER_GNU) || (HGL_COMPILER == HGL_COMPILER_MinGW32)
        #include<hgl/platform/compiler/GNU.h>
    #else
        #error Unrecognized compiler for Windows
    #endif
    ...
    #include<hgl/platform/os/BSD.h>
        ...
        #include<hgl/platform/compiler/GNU.h>
    #else
        #error Unrecognized compiler for Cygwin
    #endif
    ...
    #include<hgl/platform/os/BSD.h>
        ...
        #include<hgl/platform/compiler/GNU.h>
    #else
        #error Unrecognized compiler for BSD
    #endif
    ...
    #include<hgl/platform/os/Linux.h>
        ...
        #include<hgl/platform/compiler/GNU.h>
    #else
        #error Unrecognized compiler for Linux
    #endif
#elif (HGL_OS == HGL_OS_macOS) || (HGL_OS == HGL_OS_iOS) || (HGL_OS == HGL_OS_iPadOS) || (HGL_OS == HGL_OS_tvOS)
...
namespace hgl
{
    ...
    #if HGL_DIRECTORY_SEPARATOR == OS_TEXT('\\')
